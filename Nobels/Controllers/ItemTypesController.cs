...
namespace Nobels.Controllers
{
    public class ItemTypesController : Controller
    {
        ...
        public ItemTypesController(db_a8d242_exadecor2Context  context ,IWebHostEnvironment env)
        {
            _appEnvironment = env;
            _context = context;
        }
        ...
        {
            //var pricingDBContext = _context.ItemTypes.Include(s => s.MainItem);
            var pricingDBContext = _context.ItemTypes;
        ...
        public async Task<IActionResult> Create([Bind("TypeId,TypeArName,TypeEnName,Photopath")] ItemType itemType)
        {
         ...
         //   }
          //  else { System.Console.Write("Error"); }
            return View(itemType);
        }
